...
### Changed
- Updated node configuration exporter to convert relay pin numbers from physical header numbering to BCM numbering for compatibility with node runtime expectations.
...
### Changed
- Enhanced UI/UX across all frontend pages
