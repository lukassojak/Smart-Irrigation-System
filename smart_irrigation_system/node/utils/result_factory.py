...
def create_failure_circuit_not_idle(
        ...
        target_duration: int,
        target_water_amount: float,
        standard_conditions: Optional[StandardConditions],
        actual_conditions: Optional[GlobalConditions]
    ) -> IrrigationResult:
    ...
    return IrrigationResult(
        ...
        base_water_amount=zone_config.base_volume_liters,
        standard_conditions_solar=standard_conditions.solar_total if standard_conditions is not None else None,
        standard_conditions_rain=standard_conditions.rain_mm if standard_conditions is not None else None,
        standard_conditions_temp=standard_conditions.temperature_celsius if standard_conditions is not None else None,
        actual_solar=actual_conditions.solar_total if actual_conditions is not None else None,
        actual_rain=actual_conditions.rain_mm if actual_conditions is not None else None,
        actual_temp=actual_conditions.temperature if actual_conditions is not None else None,
        carry_over_applied=False,
        even_area_mode=zone_config.even_area_mode,
        dynamic_interval_enabled=zone_config.frequency_settings.dynamic_interval,
        irrigation_volume_threshold_percent=zone_config.frequency_settings.irrigation_volume_threshold_percent
